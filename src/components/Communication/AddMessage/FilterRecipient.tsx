...
import classesMessage from "./NewMessage.module.css";
...
import NewMessage, { messageData } from "./AddMessage";
  ...
  return (
    <div className={classes.FilterClient}>
      ...
      <div className={classes.Actions}>
        <button onClick={handleClear} className={classes.DeleteButton}>
...
const FilterRecipient: React.FC<FilterRecipientProps> = ({
  onFilterChange,
}) => {
  ...
  //   setValue("orderPriceFrom", "");
  //   setValue("orderPriceTo", "");
  // };

  // const resetOrderCategory = () => {
  //   setOrderCategory("");
  //   setValue("orderCategory", "");
  // };

  // const resetTimeOfTheDay = () => {
  //   setTimeOfTheDay("");
  //   setValue("timeOfTheDay", "");
  // };
    ...
    <div className={classes.FilterContainer}>
      ...
      <div className={classes.Filter}>
          ...
          <FormControl sx={{ mt: 0.5, minWidth: 120 }}>
            ...
            >
              <MenuItem disabled value="">
                <p className={classesMessage.menuItem}>Select Client Type</p>
              </MenuItem>
        ...
        {/*<div className={classes.FilterClient}>
          ...
          <FormControl sx={{ mt: 0.5, minWidth: 120 }}>
            <Select
              {...register("timeOfTheDay", { required: true })}
              value={timeOfTheDay}
